...
@push('scripts')
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@9.0.3"></script> <!-- Plugin de tablas interactivas (ordenar, paginar, buscar) -->
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script> <!-- Cliente HTTP para peticiones AJAX (GET, POST, etc.) -->
    <script src="https://cdn.sheetjs.com/xlsx-0.20.3/package/dist/xlsx.full.min.js"></script> <!-- Librería SheetJS para exportar/generar archivos Excel -->
    <script src="https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js"></script> <!-- Librería jsPDF para generar archivos PDF -->
    <script src="https://cdn.jsdelivr.net/npm/jspdf-autotable@5.0.2/dist/jspdf.plugin.autotable.min.js"></script> <!-- Plugin de jsPDF para tablas en PDF -->
