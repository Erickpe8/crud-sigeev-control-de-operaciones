        ...
        <div class="p-4 mt-14 border border-dashed border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div class="text-center py-16">
                ...
                <svg class="h-6 w-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                </div>
                <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200 mb-2">No tienes acceso a ningún módulo</h2>
                <p class="text-gray-600 dark:text-gray-400">Contacta con el administrador para obtener permisos.</p>
            </div>
            @endif
        </div>
        </div>
