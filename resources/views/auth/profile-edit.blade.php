...
@push('scripts')
    <script>
        /**
         * Crea o retorna el contenedor raíz de alertas flotantes en el body.
         * @returns {HTMLDivElement} Contenedor con id="alert-root-global".
         */
        ...
        /**
         * Inserta una alerta con estilos, cierre manual y autocierre opcional.
         * @param {('info'|'success'|'error'|'warning'|'neutral')} [type='info'] Tipo visual.
         * @param {string} title Título breve. @param {string} message Contenido. @param {Object} opts Opciones (propiedad timeout en ms).
         * @returns {void} No devuelve valor; altera el DOM.
         */
        ...
        /**
         * Inicializa la pantalla de edición al cargar el DOM.
         * @param — Sin parámetros (callback DOMContentLoaded).
         * @returns {void} Configura listeners, máscara de fecha y validación.
         */
        document.addEventListener('DOMContentLoaded', () => {
            ...
            /**
             * Alterna visibilidad de secciones académica/empresa según user_type_id.
             * @param — Sin parámetros (lee #user_type_id).
             * @returns {void} Solo cambia clases CSS en secciones.
             */
            ...
            /**
             * Formatea una cadena numérica a máscara dd/mm/aaaa durante la escritura.
             * @param {string} v Texto con dígitos de fecha.
             * @returns {string} Cadena en formato parcial/completo dd/mm/aaaa.
             */
            function maskDMY(v) {
            ...
            /**
             * Parsea estrictamente dd/mm/aaaa a Date válido o null.
             * @param {string} str Fecha en formato dd/mm/aaaa.
             * @returns {Date|null} Date si es válida; null si inválida.
             */
            ...
            /**
             * Determina si una fecha es futura respecto a hoy (sin hora).
             * @param {Date} dateObj Instancia de Date a evaluar.
             * @returns {boolean} True si es futura; false en caso contrario.
             */
            ...
            if (birthInput) {
                ...
                /**
                 * Valida formato dd/mm/aaaa y que no sea futura al perder foco.
                 * @param {FocusEvent} e Evento blur del input.
                 * @returns {void} Muestra alerta/estilos si aplica.
                 */
                ...
                /**
                 * Limpia la marca visual de error al enfocar el campo de fecha.
                 * @param {FocusEvent} e Evento focus del input.
                 * @returns {void} Elimina clases de error.
                 */
            ...
            /**
             * Verifica campos mínimos y habilita/deshabilita el botón de guardar.
             * @param — Sin parámetros (lee valores del form).
            ...
            /**
             * Gestiona el envío del formulario aplicando diffs y manejo de errores.
             * @param {SubmitEvent} e Evento submit del formulario.
             * @returns {Promise<void>} Resuelve tras éxito o manejo de error.
             */
