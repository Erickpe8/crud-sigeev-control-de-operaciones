...
public function update(Request $request, User $user)  // <-- inyecta el modelo
{
    try {
        ...
        // Validación "sometimes" (solo valida lo que viene)
        ...
        // Asociaciones (requiere que existan las relaciones en el modelo)
